...
<div class="card">
    <div class="card-header">
        <img src="/asset/img/resume.png" class="icon"><h4 style="margin-top: 1%;">List Lowongan</h4>
    ...
    <div class="card-body">
        <a href="{{ route('detail-lowongan', $item->id) }}" class="ahref">
        <div class="body-lowongan">
<div class="lowongan-title"><h5 class="title">{{ $item->nama_pt }}</h5></div>
<div class="lowongan-desc">{{ $item->desk_pekerjaan }}</div>
<div class="lowongan-footer">{{ $item->lokasi }}</div>
        </div>
    </a>
</div>
@endforeach
