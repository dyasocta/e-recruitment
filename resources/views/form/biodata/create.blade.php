    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 card shadow" style="border-radius: 25px; background-color: white ">
                <h3 class="fs-5 fw-bold text-left align-middle mt-3">Halaman Input Biodata
                    <hr class="diveader">
                </h3>
                ...
                <div class="col-md-12 " >
                    <h3 class="card-header fs-5 fw-bold text-left align-middle" style="border-radius: 5px">Biodata
                        {{-- <hr class="diveader"> --}}
                    </h3>
                    <div class="card-body">
                        ...
                        @csrf
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-9">
                                <input type="text" maxlength="16" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                    class="form-control" name="no_ktp" value="{{ old('no_ktp', Auth::user()->no_ktp) }}" id="no_ktp" placeholder="NO. KTP" required>
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                <label for="nama" class="col-sm-3 col-form-label">NAMA<span style="color:red">*</span></label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control" name="nama" value="{{ old('no_ktp', Auth::user()->name) }}" id="nama" placeholder="NAMA" required>
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                <label for="tanggal_lahir" class="col-sm-3 col-form-label">TANGGAL LAHIR<span style="color:red">*</span></label>
                                <div class="col-sm-9">
                                <input type="date" class="form-control" name="tanggal_lahir" value="{{ old('no_ktp', Auth::user()->tanggal_lahir) }}" id="tanggal_lahir" required>
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                <label for="tempat_lahir" class="col-sm-3 col-form-label">TEMPAT LAHIR<span style="color:red">*</span></label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control" name="tempat_lahir" value="{{ old('no_ktp', Auth::user()->tempat_lahir) }}" id="tempat_lahir" placeholder="TEMPAT LAHIR" required>
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                <label for="email" class="col-sm-3 col-form-label">EMAIL<span style="color:red">*</span></label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control" name="email" value="{{ old('no_ktp', Auth::user()->email) }}" id="email" placeholder="EMAIL" required>
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control phone" name="handphone" value="{{ old('no_ktp', Auth::user()->no_hp) }}" id="handphone" placeholder="HANDPHONE" required>
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                <label for="no_npwp" class="col-sm-3 col-form-label">NO. NPWP</label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control" name="no_npwp" id="no_npwp" placeholder="NO. NPWP">
                                </div>
                            </div>
