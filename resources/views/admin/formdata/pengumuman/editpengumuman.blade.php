...
<div class="container">
  <div class="row justify-content-center">
      <div class="col-md-12 card shadow" style="border-radius: 25px; background-color: white ">
          <h3 class="fs-5 fw-bold text-left align-middle mt-3">Halaman Edit Pengumuman
              <hr class="diveader">
          </h3>
          ...
          <div class="col-md-12 " >
              ...
              <div class="card-body">
                  ...
                  <form action="{{ route ('admin.listpengumuman.update', $pengumuman->id) }}" method="post">
                      ...
                      <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-9">
                            ...
                            placeholder="DESKRIPSI PEKERJAAN" name="desk_pekerjaan" required autofocus>{{ $pengumuman->desk_pekerjaan }}</textarea> 
                        </div>
                    </div>
