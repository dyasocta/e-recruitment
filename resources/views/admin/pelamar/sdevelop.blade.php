    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 card shadow" style="border-radius: 25px;">
                <h3 class="mt-2">Halaman Daftar Pelamar Senior Web Developer</h3>
                <hr>
                ...
                <div class="col-md-12">
                    <h3 class="card-header fs-5 fw-bold text-left align-middle" style="border-radius: 5px">
                        Daftar Pelamar Senior Web Developer
                    </h3>
                    <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered" style="width: 100%">
                                    ...
                                    <tbody>
                                        @forelse ($users as $user)
                                            @if ($user->kualifikasi == 'seniorweb')
                                                <tr>
                                                    <td class="text-left align-middle">
                                                        {{ $user->name }}
                                                    </td>
                                                    <td class="text-center align-middle">
                                                        <a class="btn" style="background-color: #FE5900; color:white" href="{{route('seniorDev.tampil_data', $user->id)}}"><i class="bi bi-eye me-1" ></i><b>Preview</b></a>
                                                    </td>
                                                </tr>
                                            @endif
                                        @empty
