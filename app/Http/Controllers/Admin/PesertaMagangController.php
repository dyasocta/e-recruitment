...
class PesertaMagangController extends Controller
{
    public function index()
    {
        ...
        return view('admin.magang.peserta',compact('title', 'users'));
    }
    ...
    public function tampil_data($id)
    {
        ...
        $foto_pelamar = DB::table('biodatas')
                ...
                ->where('biodata_user_id', $id)
                ->get();
        return view('admin.formdata.magang.datamagang',compact('title', 'biodatas', 'pendidikans', 'dokumens', 'foto_pelamar'));
    }
