...
class FreelanceController extends Controller
{
    public function index()
    {
        ...
        $title = 'Pelamar-Freelance';
        return view('admin.pelamar.freelance', compact('title', 'users'));
    }
    ...
    public function tampil_data($id)
    {
        ...
        $foto_pelamar = DB::table('biodatas')
                ...
                ->where('biodata_user_id', $id)
                ->get();
        return view('admin.formdata.pelamar.datafreelance',compact('title', 'biodatas', 'pendidikans', 'dokumens', 'foto_pelamar'));
    }
}
