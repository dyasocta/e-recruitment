...
class JuniorDevController extends Controller
{
    public function index()
    {
        $users = User::orderBy('created_at', 'ASC')->get();
        $title = 'Pelamar-Junior_WEB';
        return view('admin.pelamar.jdevelop', compact('title', 'users'));
    }
    ...
    public function tampil_data($id)
    {
        ...
        $foto_pelamar = DB::table('biodatas')
                ...
                ->where('biodata_user_id', $id)
                ->get();
        return view('admin.formdata.pelamar.datajunior',compact('title', 'biodatas', 'pendidikans', 'dokumens', 'foto_pelamar'));
    }
}
