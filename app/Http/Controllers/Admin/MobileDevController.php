...
class MobileDevController extends Controller
{
    public function index()
    {
        ...
        $title = 'Pelamar-Mobile_Dev';
        return view('admin.pelamar.mobile', compact('title', 'users'));
    }
    ...
    public function tampil_data($id)
    {
        ...
        $foto_pelamar = DB::table('biodatas')
                ...
                ->where('biodata_user_id', $id)
                ->get();
        return view('admin.formdata.pelamar.datamobile',compact('title', 'biodatas', 'pendidikans', 'dokumens', 'foto_pelamar'));
    }
}
